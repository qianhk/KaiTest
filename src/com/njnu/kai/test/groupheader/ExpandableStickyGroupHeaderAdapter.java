...
/**
 */
class ExpandableStickyGroupHeaderAdapter extends BaseAdapter implements StickyGroupHeaderAdapter {

    private final StickyGroupHeaderAdapter mInnerAdapter;
    ...
    ExpandableStickyGroupHeaderAdapter(StickyGroupHeaderAdapter innerAdapter) {
