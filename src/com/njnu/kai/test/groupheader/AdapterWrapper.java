...
/**
 * A {@link android.widget.ListAdapter} which wraps a {@link StickyGroupHeaderAdapter} and
 * automatically handles wrapping the result of
 * {@link StickyGroupHeaderAdapter#getView(int, android.view.View, android.view.ViewGroup)}
 * and
 * {@link StickyGroupHeaderAdapter#getHeaderView(int, android.view.View, android.view.ViewGroup)}
 * appropriately.
 *
 */
class AdapterWrapper extends BaseAdapter implements StickyGroupHeaderAdapter {
    ...
    final StickyGroupHeaderAdapter mDelegate;
    ...
    void setGroupHeaderEnabled(boolean enabled) {
    ...
    /**
     * Will recycle listview_group_header_list_group_header from {@link WrapperView} if it exists
     */
    ...
    /**
     * Get a listview_group_header_list_group_header view. This optionally pulls a listview_group_header_list_group_header from the supplied
    ...
    private View configureHeader(WrapperView wv, final int position) {
        ...
        //if the listview_group_header_list_group_header isn't clickable, the listselector will be drawn on top of the listview_group_header_list_group_header
    ...
    /**
     * Returns {@code true} if the previous position has the same listview_group_header_list_group_header ID.
     */
    ...
    public WrapperView getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mDivider2 == null && mDivider != null) {
            mDivider2 = mDivider.getConstantState().newDrawable().mutate();
        }
        if (mGroupDivider == null && mDivider != null) {
            mGroupDivider = mDivider.getConstantState().newDrawable().mutate();
        }
        wv.update(item, header, mDividerHeight, mDivider, mDivider2, mGroupDivider);
        return wv;
    }
