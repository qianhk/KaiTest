...
import com.njnu.kai.test.groupheader.WrapperViewList.LifeCycleListener;
 ...
 *
 */
public class StickyGroupHeaderListView extends FrameLayout {

    public interface OnHeaderClickListener {
        void onHeaderClick(StickyGroupHeaderListView l, View header,
    ...
    public interface OnStickyHeaderOffsetChangedListener {
         ...
         * @param header The currently sticky listview_group_header_list_group_header being offset.
         *               This listview_group_header_list_group_header is not guaranteed to have it's measurements set.
         ...
         * @param offset The amount the sticky listview_group_header_list_group_header is offset by towards to top of the screen.
         */
        void onStickyHeaderOffsetChanged(StickyGroupHeaderListView l, View header, int offset);
    }

    /**
     * Notifies the listener when the sticky listview_group_header_list_group_header has been updated
     */
    public interface OnStickyHeaderChangedListener {
        /**
         * @param l            The view parent
         * @param header       The new sticky listview_group_header_list_group_header view.
         * @param itemPosition The position of the item within the adapter's data set of
         *                     the item whose listview_group_header_list_group_header is now sticky.
         * @param headerId     The id of the new sticky listview_group_header_list_group_header.
         */
        void onStickyHeaderChanged(StickyGroupHeaderListView l, View header,
    ...
    private boolean mGroupHeaderEnabled = true;
    ...
    public StickyGroupHeaderListView(Context context) {
        this(context, null);
    }

    public StickyGroupHeaderListView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public StickyGroupHeaderListView(Context context, AttributeSet attrs, int defStyle) {
...
//        mList.setHeaderDividersEnabled(false);
        ...
        if (!WrapperView.USE_SYSTEM_DIVIDER) {
            mList.setDivider(null);
            mList.setDividerHeight(0);
        }

        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs, R.styleable.StickyGroupHeaderListView, 0, 0);

            try {
                // -- View attributes --
                int padding = a.getDimensionPixelSize(R.styleable.StickyGroupHeaderListView_android_padding, 0);
                mPaddingLeft = a.getDimensionPixelSize(R.styleable.StickyGroupHeaderListView_android_paddingLeft, padding);
                mPaddingTop = a.getDimensionPixelSize(R.styleable.StickyGroupHeaderListView_android_paddingTop, padding);
                mPaddingRight = a.getDimensionPixelSize(R.styleable.StickyGroupHeaderListView_android_paddingRight, padding);
                mPaddingBottom = a.getDimensionPixelSize(R.styleable.StickyGroupHeaderListView_android_paddingBottom, padding);

                setPadding(mPaddingLeft, mPaddingTop, mPaddingRight, mPaddingBottom);

                // Set clip to padding on the list and reset value to default on
                // wrapper
                mClippingToPadding = a.getBoolean(R.styleable.StickyGroupHeaderListView_android_clipToPadding, true);
                super.setClipToPadding(true);
                mList.setClipToPadding(mClippingToPadding);

                // scrollbars
                final int scrollBars = a.getInt(R.styleable.StickyGroupHeaderListView_android_scrollbars, 0x00000200);
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.GINGERBREAD) {
                    mList.setOverScrollMode(a.getInt(R.styleable.StickyGroupHeaderListView_android_overScrollMode, 0));
                }

                // -- ListView attributes --
                mList.setFadingEdgeLength(a.getDimensionPixelSize(R.styleable.StickyGroupHeaderListView_android_fadingEdgeLength,
                        mList.getVerticalFadingEdgeLength()));
                final int fadingEdge = a.getInt(R.styleable.StickyGroupHeaderListView_android_requiresFadingEdge, 0);
                ...
                mList.setCacheColorHint(a
                        .getColor(R.styleable.StickyGroupHeaderListView_android_cacheColorHint, mList.getCacheColorHint()));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    mList.setChoiceMode(a.getInt(R.styleable.StickyGroupHeaderListView_android_choiceMode,
                            mList.getChoiceMode()));
                }
                mList.setDrawSelectorOnTop(a.getBoolean(R.styleable.StickyGroupHeaderListView_android_drawSelectorOnTop, false));
                mList.setFastScrollEnabled(a.getBoolean(R.styleable.StickyGroupHeaderListView_android_fastScrollEnabled,
                        mList.isFastScrollEnabled()));
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    mList.setFastScrollAlwaysVisible(a.getBoolean(
                            R.styleable.StickyGroupHeaderListView_android_fastScrollAlwaysVisible,
                            mList.isFastScrollAlwaysVisible()));
                }

                mList.setScrollBarStyle(a.getInt(R.styleable.StickyGroupHeaderListView_android_scrollbarStyle, 0));

                if (a.hasValue(R.styleable.StickyGroupHeaderListView_android_listSelector)) {
                    mList.setSelector(a.getDrawable(R.styleable.StickyGroupHeaderListView_android_listSelector));
                }

                mList.setScrollingCacheEnabled(a.getBoolean(R.styleable.StickyGroupHeaderListView_android_scrollingCache,
                        mList.isScrollingCacheEnabled()));

                if (a.hasValue(R.styleable.StickyGroupHeaderListView_android_divider)) {
                    mDivider = a.getDrawable(R.styleable.StickyGroupHeaderListView_android_divider);
                }

                mDividerHeight = a.getDimensionPixelSize(R.styleable.StickyGroupHeaderListView_android_dividerHeight,
                        mDividerHeight);

                mList.setTranscriptMode(a.getInt(R.styleable.StickyGroupHeaderListView_android_transcriptMode,
                        ListView.TRANSCRIPT_MODE_DISABLED));

                // -- StickyListHeaders attributes --
                mAreHeadersSticky = a.getBoolean(R.styleable.StickyGroupHeaderListView_hasStickyHeaders, true);
                mIsDrawingListUnderStickyHeader = a.getBoolean(
                        R.styleable.StickyGroupHeaderListView_isDrawingListUnderStickyHeader,
                        true);
            } finally {
                a.recycle();
            }
    ...
    public void setGroupHeaderEnabled(boolean enabled) {
        mGroupHeaderEnabled = enabled;
        if (mAdapter != null) {
            mAdapter.setGroupHeaderEnabled(enabled);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        // The listview_group_header_list_group_header should be drawn right after the lists children are drawn.
        // This is done so that the listview_group_header_list_group_header is above the list items
     ...
     */
    public void setDragListener(DraggableListView.DragListener l) {
        mList.setDragListener(l);
    }
     ...
     */
    public void setDropListener(DraggableListView.DropListener l) {
        mList.setDropListener(l);
    }

    public void setDragStartViewId(int dragViewId) {
        mList.setDragStartViewId(dragViewId);
    }

    public boolean collapse() {
        return mList.collapse();
    }

    // Reset values tied the listview_group_header_list_group_header. also remove listview_group_header_list_group_header form layout
    ...
    private void updateHeader(int headerPosition) {
        ...
        // check if there is a new listview_group_header_list_group_header should be sticky
        if (mHeaderPosition == null || mHeaderPosition != headerPosition) {
            ...
            if (mHeaderId == null || mHeaderId != headerId) {
                ...
                if (mHeader != header) {
                    if (header == null) {
                        throw new NullPointerException("listview_group_header_list_group_header may not be null");
                    }
                    swapHeader(header);
                }
                ...
                // that it will be set on the listview_group_header_list_group_header and
        ...
        // Calculate new listview_group_header_list_group_header offset
            ...
            mHeader.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    mOnHeaderClickListener.onHeaderClick(
                            StickyGroupHeaderListView.this, mHeader,
    ...
    // hides the headers in the list under the sticky listview_group_header_list_group_header.
    ...
    private void updateHeaderVisibilities() {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            // ensure wrapper view child has a listview_group_header_list_group_header
            WrapperView wrapperViewChild = (WrapperView)child;
            if (!wrapperViewChild.hasHeader()) {
                continue;
            }

            // update listview_group_header_list_group_header views visibility
    ...
    // Wrapper around setting the listview_group_header_list_group_header offset in different ways depending on
    // the API version
    @SuppressLint("NewApi")
    ...
    private class WrapperViewListLifeCycleListener implements LifeCycleListener {
        ...
        public void onDispatchDrawOccurred(Canvas canvas) {
            ...
            // therefor we need to update the listview_group_header_list_group_header here as well.
    ...
    private class AdapterWrapperHeaderClickHandler implements
        ...
        public void onHeaderClick(View header, int itemPosition, long headerId) {
            mOnHeaderClickListener.onHeaderClick(
                    StickyGroupHeaderListView.this, header, itemPosition,
                    headerId, false);
        }
    ...
    /**
     * @param stickyHeaderTopOffset The offset of the sticky listview_group_header_list_group_header fom the top of the view
     */
    ...
    public void setAdapter(StickyGroupHeaderAdapter adapter, int toggleButtonId, int expandableViewId) {
        ...
        mAdapter.setDivider2(mDivider2);
        mAdapter.setGroupDivider(mGroupDivider);
        if (WrapperView.USE_SYSTEM_DIVIDER) {
            mList.setDivider(mDivider);
            mList.setDividerHeight(mDividerHeight);
        }

        mList.setAdapter(mAdapter, toggleButtonId, expandableViewId);
        clearHeader();
    }

    public StickyGroupHeaderAdapter getAdapter() {
    ...
    public void setDivider2(Drawable divider) {
        mDivider2 = divider;
        if (mAdapter != null) {
            mAdapter.setDivider2(mDivider2);
        }
    ...
    public void setGroupDivider(Drawable divider) {
        mGroupDivider = divider;
        if (mAdapter != null) {
            mAdapter.setGroupDivider(mGroupDivider);
        }
    }
        ...
        if (l != null) {
            mList.setOnTouchListener(new OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    return l.onTouch(StickyGroupHeaderListView.this, event);
                }
            });
        } else {
