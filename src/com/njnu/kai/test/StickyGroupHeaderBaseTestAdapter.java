...
public class StickyGroupHeaderBaseTestAdapter extends BaseAdapter implements
        StickyGroupHeaderAdapter, SectionIndexer {

    private static final String LOG_TAG = "StickyGroupHeaderBaseTestAdapter";
    ...
    public StickyGroupHeaderBaseTestAdapter(Context context) {
        mContext = context;
