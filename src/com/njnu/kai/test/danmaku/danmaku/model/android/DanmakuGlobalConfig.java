...
import com.njnu.kai.test.danmaku.danmaku.model.AlphaValue;
import com.njnu.kai.test.danmaku.danmaku.model.BaseDanmaku;
import com.njnu.kai.test.danmaku.danmaku.model.GlobalFlagValues;
...
public class DanmakuGlobalConfig {
    ...
    private <T> void setFilterData(String tag, T data) {
        ...
        DanmakuFilters.IDanmakuFilter<T> filter = (DanmakuFilters.IDanmakuFilter<T>)DanmakuFilters.getDefault().get(tag);
        filter.setData(data);
    }
