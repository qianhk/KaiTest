...
package com.njnu.kai.test.danmaku.danmaku.parser;
...
public class DanmakuFactory {
    ...
    public final static long COMMON_DANMAKU_DURATION = 6000; // B站原始分辨率下弹幕存活时间

    public static final int DANMAKU_MEDIUM_TEXTSIZE = 25;

    public final static long MIN_DANMAKU_DURATION = 6500;
