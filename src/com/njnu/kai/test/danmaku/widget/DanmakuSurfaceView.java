...
package com.njnu.kai.test.danmaku.widget;
...
import com.njnu.kai.test.danmaku.controller.DrawHelper;
...
public class DanmakuSurfaceView extends SurfaceView implements IDanmakuView, SurfaceHolder.Callback {
    ...
    protected Looper getLooper(int type) {
        ...
        String threadName = "Danmaku Drawing thread #" + priority;
    ...
    public void start(long postion) {
        ...
        if (handler.hasMessages(DrawHandler.NOTIFY_STOP)) {
            handler.removeMessages(DrawHandler.NOTIFY_STOP);
        }
