...
import com.njnu.kai.test.danmaku.bitmap.NativeBitmapFactory;
import com.njnu.kai.test.danmaku.danmaku.model.*;
import com.njnu.kai.test.danmaku.danmaku.model.android.DanmakuGlobalConfig;
import com.njnu.kai.test.danmaku.danmaku.model.android.DanmakuGlobalConfig.DanmakuConfigTag;
import com.njnu.kai.test.danmaku.danmaku.model.android.Danmakus;
import com.njnu.kai.test.danmaku.danmaku.model.android.DrawingCache;
import com.njnu.kai.test.danmaku.danmaku.model.android.DrawingCachePoolManager;
import com.njnu.kai.test.danmaku.danmaku.model.objectpool.Pool;
import com.njnu.kai.test.danmaku.danmaku.model.objectpool.Pools;
...
import com.njnu.kai.test.danmaku.danmaku.util.DanmakuUtils;
...
public class CacheManagingDrawTask extends DrawTask {
    ...
    public IRenderer.RenderingState draw(AbsDisplayer<?> displayer) {
        IRenderer.RenderingState result = null;
    ...
    public class CacheManager {
        ...
        public void begin() {
            if (mThread == null) {
                mThread = new HandlerThread("Danmaku Cache-Building Thread");
                mThread.start();
            }
            if (mHandler == null)
...
//                        Log.i(TAG,"BUILD_CACHES:"+mCacheTimer.currMillisecond+":"+mTimer.currMillisecond);
    ...
    //                        message = "break at last.time < mTimer.currMillisecond";
                        ...
                        boolean skip = filters.filter(item, orderInScreen,
