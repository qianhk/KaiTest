 ...
 * @since 15/11/7
 */
public class ExpandWithAnimationActivity extends ListActivity {
    ...
    private static class ExpandableAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = mLayoutInflater.inflate(R.layout.activity_expand_with_animation_item, parent, false);
