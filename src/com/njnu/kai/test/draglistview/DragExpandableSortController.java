...
/**
 */
public class DragExpandableSortController extends SimpleFloatViewController
    ...
    private DraggableExpandableListView mDslv;
     ...
     */
    public DragExpandableSortController(DraggableExpandableListView dslv, int dragHandleId,
                                        int dragInitMode) {
        super(dslv);
        mDslv = dslv;
