    ...
    private class AdapterWrapper extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView != null) {
                ...
                child = mAdapter.getView(position, oldChild, DraggableListView.this);
                if (child != oldChild) {
                    if (oldChild != null) {
                        v.removeViewAt(0);
                    }
                ...
                child = mAdapter.getView(position, null, DraggableListView.this);
...
//        LogUtils.v("testitemheight", "item: " + mItemHeightCollapsed);
    ...
    private class DropAnimator extends SmoothAnimator {
        ...
        public void onStart() {
            mDropPos = mFloatPos;
            mSrcPos = DraggableListView.this.mSrcPos;
            mDragState = DROPPING;
...
//        mCurrFloatAlpha = mFloatAlpha;
    ...
    public void setDragStartViewId(int dragViewId) {
        if (mFloatViewController instanceof DragSortController) {
            ((DragSortController) mFloatViewController).setDragHandleId(dragViewId);
        }
    }
