...
public final class Scene {
     ...
     *                  and android.support.transitions will take place.
     ...
     * created by the caching factory method {@link android.support.transitions.Scene#getCurrentScene(android.view.View)}.</p>
     *
     * @param sceneRoot The root of the hierarchy in which scene changes
     *                  and android.support.transitions will take place.
     ...
     * anything else the application needs after android.support.transitions have
     ...
     * @see android.support.transitions.Scene#Scene(android.view.ViewGroup, int, android.content.Context)
     * @see android.support.transitions.Scene#Scene(android.view.ViewGroup, android.view.ViewGroup)
     */
     ...
     * will cause Scene to call back into application code to do
     * anything the application needs to do after applicable android.support.transitions have
