...
/**
 * A TransitionSet is a parent of child android.support.transitions (including other
 * TransitionSets). Using TransitionSets enables more complex
 * choreography of android.support.transitions, where some sets play {@link #ORDERING_TOGETHER} and
 ...
 * attributes of {@link android.support.transitions.R.styleable#TransitionSet} and
 * {@link android.support.transitions.R.styleable#Transition}. Child android.support.transitions of the
...
public class TransitionSet extends Transition {
    ...
    /**
     * A flag used to indicate that the child android.support.transitions of this set
     * should all start at the same time.
     */
    public static final int ORDERING_TOGETHER = 0;
    /**
     * A flag used to indicate that the child android.support.transitions of this set should
    ...
    /**
     * Constructs an empty transition set. Add child android.support.transitions to the
     * set by calling {@link #addTransition(Transition)} )}. By default,
     * child android.support.transitions will play {@link #ORDERING_TOGETHER together}.
     */
    ...
    /**
     * Sets the play order of this set's child android.support.transitions.
     *
     * @param ordering {@link #ORDERING_TOGETHER} to play this set's child
     *                 android.support.transitions together, {@link #ORDERING_SEQUENTIAL} to play the child
     *                 android.support.transitions in sequence.
     ...
     *
     * @return {@link #ORDERING_TOGETHER} if child android.support.transitions will play at the same
     ...
     * is added relative to other child android.support.transitions that are added, in addition to
     * the {@link #getOrdering() ordering} property, determines the
     * order in which the android.support.transitions are started.
     * <p/>
    ...
    /**
     * Returns the number of child android.support.transitions in the TransitionSet.
     *
     * @return The number of child android.support.transitions in the TransitionSet.
     ...
     * android.support.transitions (current and future) to inherit this duration.
     *
    ...
    /**
     * Sets up listeners for each of the child android.support.transitions. This is used to
     * determine when this transition set is finished (all child android.support.transitions
     * must finish first).
     */
    ...
    /**
     * This listener is used to detect when all child android.support.transitions are done, at
    ...
    protected void createAnimators(ViewGroup sceneRoot, TransitionValuesMaps startValues,
        ...
        for (int i = 0; i < numTransitions; i++) {
            ...
            // the android.support.transitions sequentially.
