 ...
 * {@link #onDisappear(android.view.ViewGroup, TransitionValues, int, TransitionValues, int)} or
 * {@link #onAppear(android.view.ViewGroup, android.view.View, TransitionValues, TransitionValues)},
 * {@link #onDisappear(android.view.ViewGroup, android.view.View, TransitionValues, TransitionValues)}.
 */
...
public abstract class Visibility extends Transition {
     ...
     * parameter in {@link #onDisappear(android.view.ViewGroup, android.view.View, TransitionValues, TransitionValues)}.
     * If a visible View is changed to be {@link android.view.View#GONE} or {@link android.view.View#INVISIBLE},
     * then it can be used as the <code>view</code> and the visibility will be changed
     * to {@link android.view.View#VISIBLE} for the duration of the animation. However, if a View
     ...
     * the previous {@link Scene} was {@link Scene#getSceneForLayout(android.view.ViewGroup, int,
