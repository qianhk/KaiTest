...
import android.support.transitions.utils.AnimatorUtils;
import android.support.transitions.utils.ArrayMap;
import android.support.transitions.utils.Objects;
import android.support.transitions.utils.ViewUtils;
 ...
 * choreograph several child android.support.transitions ({@link TransitionSet} or they may
 ...
 * a non-UI thread, so changes to the view due to android.support.transitions (such as moving
 * and resizing the view) may be out of sync with the display inside those bounds.
 * TextureView is more compatible with android.support.transitions in general, but some
 * specific android.support.transitions (such as {@link Fade}) may not be compatible
 ...
 * {@link ChangeBounds} and {@link Fade} child android.support.transitions:</p>
 * <p/>
 * {@sample
 ...
 * takes a set of {@link android.support.transitions.R.styleable#TransitionTarget target} tags, each
 ...
 * <p/>
 * Further information on XML resource descriptions for android.support.transitions can be found for
 * {@link android.support.transitions.R.styleable#Transition}, {@link android.support.transitions.R.styleable#TransitionSet},
 * {@link android.support.transitions.R.styleable#TransitionTarget}, and {@link android.support.transitions.R.styleable#Fade},
 * {@link android.support.transitions.R.styleable#Slide}, and {@link android.support.transitions.R.styleable#ChangeTransform}.
 */
...
public abstract class Transition implements Cloneable {
    ...
    // Per-animator information used for later canceling when future android.support.transitions overlap
    ...
    // Whether this transition has ended. Used to avoid pause/resume on android.support.transitions
    // that have completed
    ...
    // For Fragment shared element android.support.transitions, linking views explicitly by mismatching
    // transitionNames.
     ...
     * When any transition is started on a given scene root, all android.support.transitions
     ...
     * old android.support.transitions and new android.support.transitions on the same targets run in parallel,
     ...
     * child android.support.transitions in sequence, then some of the child android.support.transitions may
     ...
     * and calls {@link #createAnimator(android.view.ViewGroup, TransitionValues, TransitionValues)}
     ...
     * @see #createAnimator(android.view.ViewGroup, TransitionValues, TransitionValues)
     */
     ...
     * <p/>
     * <p>Excluding targets is a general mechanism for allowing android.support.transitions to run on
    ...
    /**
     * This method can be called by android.support.transitions to get the TransitionValues for
     ...
     * {@link android.support.transitions.Transition#createAnimator(android.view.ViewGroup, TransitionValues,
     ...
     * between different android.support.transitions to determine when interrupting android.support.transitions overlap.
    ...
    public static interface TransitionListener {
        ...
        /**
         * Notification about the end of the transition. Canceled android.support.transitions
         * will always notify listeners of both the cancellation and end
         * events. That is, {@link #onTransitionEnd(android.support.transitions.Transition)} is always called,
         ...
         * to {@link #onTransitionPause(android.support.transitions.Transition)}.
         *
     ...
     * while other android.support.transitions are still running to determine whether a running
     ...
     * {@link #setEpicenterCallback(android.support.transitions.Transition.EpicenterCallback)} to
     ...
     * @see #setEpicenterCallback(android.support.transitions.Transition.EpicenterCallback)
     */
    public static abstract class EpicenterCallback {

        /**
         * Implementers must override to return the epicenter of the Transition in screen
         * coordinates. Transitions like {@link android.support.transitions.Explode} depend upon
         ...
         * {@link android.support.transitions.Fade} pay no attention to the epicenter.
         *
