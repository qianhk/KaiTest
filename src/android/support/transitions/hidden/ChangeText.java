...
package android.support.transitions.hidden;
...
import android.support.transitions.TransitionValues;
...
public class ChangeText extends Transition {
     ...
     * android.support.transitions to be run sequentially or in parallel with these fades.
     *
     * @see #setChangeBehavior(int)
     */
     ...
     * transition, possibly with other android.support.transitions running as well, such as
