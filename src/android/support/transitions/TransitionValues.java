 ...
 * according to names selected by the android.support.transitions. These names should
 * be unique to avoid clobbering values stored by other android.support.transitions,
 ...
 * {@link Transition#captureStartValues(android.support.transitions.TransitionValues)}
 ...
 * passed into the android.support.transitions via the
 * for {@link Transition#createAnimator(android.view.ViewGroup, android.support.transitions.TransitionValues, android.support.transitions.TransitionValues)}
 * method.</p>
 */
public class TransitionValues {
    ...
    /**
     * The set of values tracked by android.support.transitions for this scene
     */
